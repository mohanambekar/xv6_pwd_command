...
main(int argc, char *argv[])
{
   ...
   f:	51                   	push   %ecx
    ...
    c = 'a';
    write(fd, &c, 1);
  10:	8d 75 e7             	lea    -0x19(%ebp),%esi
{
  13:	83 ec 28             	sub    $0x28,%esp
    mkdir("mohan");
  16:	68 b8 07 00 00       	push   $0x7b8
  1b:	e8 3a 03 00 00       	call   35a <mkdir>
    fd = open("/mohan/1.txt", O_CREATE|O_RDWR);
  20:	58                   	pop    %eax
  21:	5a                   	pop    %edx
  22:	68 02 02 00 00       	push   $0x202
  27:	68 be 07 00 00       	push   $0x7be
  2c:	e8 01 03 00 00       	call   332 <open>
    write(fd, &c, 1);
  31:	83 c4 0c             	add    $0xc,%esp
    fd = open("/mohan/1.txt", O_CREATE|O_RDWR);
  34:	89 c3                	mov    %eax,%ebx
    c = 'a';
  36:	c6 45 e7 61          	movb   $0x61,-0x19(%ebp)
    write(fd, &c, 1);
  3a:	6a 01                	push   $0x1
  3c:	56                   	push   %esi
  3d:	50                   	push   %eax
  3e:	e8 cf 02 00 00       	call   312 <write>
    c = 'a';
    write(fd, &c, 1);
  43:	83 c4 0c             	add    $0xc,%esp
    c = 'a';
  46:	c6 45 e7 61          	movb   $0x61,-0x19(%ebp)
    write(fd, &c, 1);
  4a:	6a 01                	push   $0x1
  4c:	56                   	push   %esi
  4d:	53                   	push   %ebx
  4e:	e8 bf 02 00 00       	call   312 <write>
    c = 'a';
    write(fd, &c, 1);
  53:	83 c4 0c             	add    $0xc,%esp
    c = 'a';
  56:	c6 45 e7 61          	movb   $0x61,-0x19(%ebp)
    write(fd, &c, 1);
  5a:	6a 01                	push   $0x1
  5c:	56                   	push   %esi
  5d:	53                   	push   %ebx
  5e:	e8 af 02 00 00       	call   312 <write>
    c = 'a';
    write(fd, &c, 1);
  63:	83 c4 0c             	add    $0xc,%esp
    c = 'a';
  66:	c6 45 e7 61          	movb   $0x61,-0x19(%ebp)
    write(fd, &c, 1);
  6a:	6a 01                	push   $0x1
  6c:	56                   	push   %esi
  6d:	53                   	push   %ebx
  6e:	e8 9f 02 00 00       	call   312 <write>
    c = 'a';
    write(fd, &c, 1);
  73:	83 c4 0c             	add    $0xc,%esp
    c = 'a';
  76:	c6 45 e7 61          	movb   $0x61,-0x19(%ebp)
    write(fd, &c, 1);
  7a:	6a 01                	push   $0x1
  7c:	56                   	push   %esi
  7d:	53                   	push   %ebx
  7e:	e8 8f 02 00 00       	call   312 <write>
    close(fd);
  83:	89 1c 24             	mov    %ebx,(%esp)
  86:	e8 8f 02 00 00       	call   31a <close>
}
  8b:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb cb 07 00 00       	mov    $0x7cb,%ebx
        while(*s != 0){
